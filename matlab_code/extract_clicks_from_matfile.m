...
% Path to save data
if isunix
    base_save_folder = '~/Dropbox/Z_wjlee/grampus_suction_cup/ANALYSIS/';
else
    base_save_folder = 'C:\Users\Wu-Jung Lee\Dropbox\Z_wjlee\grampus_suction_cup\ANALYSIS\';
end
...
save(fullfile(save_path,save_fname),'param','click_extracted','detected_call');
